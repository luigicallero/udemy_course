...
class App extends Component {
  ...
  componentDidMount = async () => {
    try {
      ...
      this.kycInstanceInstance = new this.web3.eth.Contract(
        KycContract.abi,
  ...
  handleKycWhitelisting = async () => {
    ...
    await this.kycInstanceInstance.methods.kycCompleted(this.state.kycAddress).send({from: this.accounts[0]});
