...
class App extends Component {
  ...
  handleInputChange = (event) => {
    ...
    this.setState({
      [name]: value // this will allow to save both cost or itemName
    }); 
  }
  ...
  render() {
    ...
    return (
      <div className="App">
        <h1>Event Trigger / Supply Change Example</h1>
        <h2>Items</h2>
        <h2>Add Items</h2>
        ...
        <button type="button" label="Create new item" onClick={this.handleSubmit}> Create new item </button>
